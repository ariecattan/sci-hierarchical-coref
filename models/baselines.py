...
class EntailmentModel(nn.Module):
    ...
    # def func(self, clusters, topic, concatenate=True):
    #     if concatenate:
    #         candidates, cluster_ids = zip(*{c_id: ', '.join(topic['mention_text'][mentions])
    #                                         for c_id, mentions in clusters.items()}.items())
    #     else:
